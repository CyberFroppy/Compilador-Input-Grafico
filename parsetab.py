...
_lr_productions = [
  ...
  ('vars_func -> ID n_seen_var_name COLON tipo n_set_var_type COMA vars_aux','vars_func',7,'p_vars_func','lexerparser.py',150),
  ...
  ('n_seen_var_name -> <empty>','n_seen_var_name',0,'p_n_seen_var_name','lexerparser.py',298),
  ('n_seen_func_name -> <empty>','n_seen_func_name',0,'p_n_seen_func_name','lexerparser.py',307),
  ('n_set_var_type -> <empty>','n_set_var_type',0,'p_n_set_var_type','lexerparser.py',317),
]
